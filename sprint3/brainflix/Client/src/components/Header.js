...
class Header extends Component {
    ...
    render() {
        ...
        return (
            ...
            <Link to={'/main'}>
                <img className="logo" src='../assets/Icons/BrainFlixLogo.svg' alt="brainFlix logo"></img>
            </Link>
                ...
                <div className="user">
                    <Link to={'/upload'}>
                            <img className="upload" src='../assets/Icons/ContentUpload.svg' alt="upload button"></img>
                    </Link>
